...
<head>
    ...
    <title>Видео и мультфильмы</title>
</head>
<body>
    <header class="header">
        <div class="container">
            <nav class="nav">
                <div class="logo">
                    <a class="logo" href="index.html">
                        ...
                        <p class="main-text-mobilu">Видео и мультфильмы</p>
                       </a>
                </div>
                <div class="link-nav-login">
                    ...
                    <a class="link-nav active" href="cartoons.php">Мультфильмы</a>
                    <div class="login">
                    <?php
                    if (!$isUserLoggedIn) {
    ...
    <main class="main">
        <div class="container">
            <h1 class="task-title">Видео и мультфильмы</h1>
           <div class="rows-cartoons">
            <div class="rows-cartoons-video">
                <iframe width="800" height="490" src="https://www.youtube.com/embed/zn-WjcBSCyA?si=aG8VFCKbeyO3yVxJ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                <iframe width="800" height="490" src="https://www.youtube.com/embed/K71MTOmmyTk?si=q3Z22raSYf9YkQUQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            <h2 class="title-new-video">Новое</h2>
            <div class="new-cartoons-video">
                <iframe width="390" height="220" src="https://www.youtube.com/embed/pL_e3E6taCk?si=jfnTXgCr9LlP4OpW" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                <iframe width="390" height="220" src="https://www.youtube.com/embed/oSXttPjjb4I?si=5jJ42QyJ-7rFJiy9" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                <iframe width="390" height="220" src="https://www.youtube.com/embed/a9K7zNmmyxs?si=w4ytwNYvKOhBaDgg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                <iframe width="390" height="220" src="https://www.youtube.com/embed/2GD7f9AyMBI?si=WkJICbyt4Pvgpv2M" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
           </div>
        </div>
    </main>
